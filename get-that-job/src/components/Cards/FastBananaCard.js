...
import { StyledAppliedButton } from "../Buttons/Buttons";
...
function FastBananaCardForm() {
  return (
    <StyledCard>
      <StyledContainer>
        <StyledLogoTitle>
          <img
            src={require("../CompanyLogos/fastbanana.png")}
            alt="fastbanana"
          />
        ...
        <StyledCardFooter>
          ...
          <StyledAppliedButton>APPLIED</StyledAppliedButton>
        </StyledCardFooter>
      </StyledContainer>
    </StyledCard>
  );
...
export default FastBananaCardForm;
